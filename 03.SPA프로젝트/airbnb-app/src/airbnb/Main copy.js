...
const Main = (props) => {
  ...
  const chgIntro = (e) => {
    ...
    let txt2 = document.querySelectorAll(".txtbx").innerText.trim();
    console.log(txt);
    setMainSts(2);
    setTimeout(() => {
      setMainSts(1);
  ...
  const chkFn = () => {
    console.log('여기링크');
    let tg = document.querySelectorAll('.slider>li>a');
    console.log(tg);
    tg.forEach(
      (ele) =>
        (ele.onclick = () => {
            ...
            <div className='nature'>
              <a href='#' onClick={chgIntro}>
                ...
                <div className='imgbx'>
                  ...
                  <img src='./images/자연.png' alt='자연이미지' />
                </div>
            </div>
            {/* 건축 */}
            <div className='build'>
              <a href='#' onClick={chgIntro}>
                ...
                <div className='imgbx'>
                  ...
                  <img src='./images/건축.png' alt='건축이미지' />
                </div>
            </div>
          </div>
        </section>
